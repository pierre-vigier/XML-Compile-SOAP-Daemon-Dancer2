...
The plugin export a keyword wsdl_endpoint, that that 2 arguments, a route path and an options hashref.
...
For each operation, define a sub in the class, soapaction_{operation_name}, each sub will be called with
